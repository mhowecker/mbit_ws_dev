...
static const _HeadState_Request_type_support_symbol_names_t _HeadState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mbit_interfaces, srv, HeadState_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mbit_interfaces, srv, HeadState_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mbit_interfaces, srv, HeadState_Request)() {
  return &::mbit_interfaces::srv::rosidl_typesupport_c::HeadState_Request_message_type_support_handle;
}
...
static const _HeadState_Response_type_support_symbol_names_t _HeadState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mbit_interfaces, srv, HeadState_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mbit_interfaces, srv, HeadState_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mbit_interfaces, srv, HeadState_Response)() {
  return &::mbit_interfaces::srv::rosidl_typesupport_c::HeadState_Response_message_type_support_handle;
}
...
static const _HeadState_type_support_symbol_names_t _HeadState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mbit_interfaces, srv, HeadState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mbit_interfaces, srv, HeadState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mbit_interfaces, srv, HeadState)() {
  return &::mbit_interfaces::srv::rosidl_typesupport_c::HeadState_service_type_support_handle;
}
